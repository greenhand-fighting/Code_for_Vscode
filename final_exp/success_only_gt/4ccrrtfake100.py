...
class CCRRT:
    ...
    def __init__(self, car, start, goal, obstacle_list,obstacle_list_from_pu, rand_area,obstacle_list_for_pengzhuang_jiance):
        """
        Setting Parameter
        ...
        self.obstacle_list_from_pu=obstacle_list_from_pu
