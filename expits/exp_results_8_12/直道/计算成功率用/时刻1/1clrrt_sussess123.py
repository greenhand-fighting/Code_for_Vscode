...
def main():
    ...
    maxcc_list_100times_succ_3 = []
    mincc_list_100times_succ_3 = []
    avgcc_list_100times_succ_3 = []
    long_list_100times_succ_3 = []
    pointnumber_list_100times_succ_3 = []
    fail1 = 0
    fail2=0
    fail3=0
    cycle_times = 0
    for i in range(100):
        ...
        if pengzhuang: #碰撞
            ...
            if len(cc_rrt.path_end): # 有完整路径
                ...
                # 处处risk 合格
                if path_max < 1 - cc_rrt.p_safe:
                    long_list_100times_succ_3.append(sum)
                    maxcc_list_100times_succ_3.append(path_max)
                    mincc_list_100times_succ_3.append(path_min)
                    avgcc_list_100times_succ_3.append(path_avg)
                else:
                    fail3+=1
    ...
    long_list_100times_succ_2 = np.array(long_list_100times_succ_2)
    maxcc_list_100times_succ_2 = np.array(maxcc_list_100times_succ_2)
    mincc_list_100times_succ_2 = np.array(mincc_list_100times_succ_2)
    avgcc_list_100times_succ_2 = np.array(avgcc_list_100times_succ_2)

    pointnumber_list_100times_succ_3 = np.array(pointnumber_list_100times_succ_3)
    long_list_100times_succ_3 = np.array(long_list_100times_succ_3)
    maxcc_list_100times_succ_3 = np.array(maxcc_list_100times_succ_3)
    mincc_list_100times_succ_3 = np.array(mincc_list_100times_succ_3)
    avgcc_list_100times_succ_3 = np.array(avgcc_list_100times_succ_3)
    print("standard 1")
    ...
    print("success rate1: %f" % success_rate1)
    ...
    print("success rate2: %f" % success_rate2)

    print("standard 3")
    print("max: %f" % np.average(maxcc_list_100times_succ_3))
    print("avg: %f" % np.average(avgcc_list_100times_succ_3))
    print("min: %f" % np.average(mincc_list_100times_succ_3))
    print("points: %f" % np.average(pointnumber_list_100times_succ_3))
    print("changdu: %f" % np.average(long_list_100times_succ_3))
    print('*' * 100)
    print("fail3=:= %f" % fail3)
    print(cycle_times)
    success_rate3 = (cycle_times - fail3) / (cycle_times)
    print("success rate3: %f" % success_rate3)
