...
class CCRRT:
    ...
    def __init__(self, car, start, goal, obstacle_list, rand_area):
        ...
        self.max_n_node = 2000  # save no more than max_node nodes on tree
        ...
        self.p_safe = 0.90  # p_safe for chance constraint#-------------------------------------------------------------------------------这是对完全系数
    ...
    def draw_graph(self, rnd=None):
       ...
       # plt.title("With considering uncertainty \nccrrt    P_safe:%f" % self.p_safe)
    ...
    def draw_path(self):
       ...
       # plt.title("With considering uncertainty\nccrrt    P_safe:%f" % self.p_safe)
        ...
        #plt.legend(loc=0, fontsize=20,edgecolor='blue')
   ...
   # draw_label=True
    for obs in obs_list:
       # x=0
        ...
        # if draw_label:
        #     draw_label=False
        #     plt.plot([p0[0], p1[0]], [p0[1], p1[1]], 'k', color="orange", lw='1',label="ego_vehicle")
        #     plt.plot([p0[0], p1[0]], [p0[1], p1[1]], 'k', color="green", lw='1',label="ground_truth")
...
def main():
    ...
    draw_carsize_of_final_path(cc_rrt.path)  # 这里的path的点是倒序的
    plt.axis([area[0]-10, area[1], area[2], area[3]])
    # 画路
  ...
  #  plt.title("With considering uncertainty\nccrrt    P_safe:%f" % cc_rrt.p_safe)
    ...
    plt.colorbar()
    plt.axis([area[0], area[1], area[2]-15, area[3]])
    # 画路
    plt.plot([0, 0], [30, 105], color="grey")
    plt.plot([14.4, 14.4], [30, 105], color="grey")
    plt.plot([3.6, 3.6], [30, 105], "--", color="grey")
